...
def process_video(frames, model, fps, device, clip_length=30):
    """
    ...
    frames = frames[:num_clips * clip_length]  # Ensure divisible by clip_length
    clips = frames.reshape(num_clips, clip_length, 3, 128, 128)
    clips = clips.transpose(0, 2, 1, 3, 4)  # Rearrange to [num_clips, channels, frames, height, width]
...
input_folder = 'dataset_new/cropped_aligned/video96'
output_path = 'rppg_results/video96'
